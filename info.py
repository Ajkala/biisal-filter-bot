...
PICS = (environ.get('PICS', 'https://telegra.ph/file/eb16943f1910dfb7d964a.jpg')).split() #use a gif video 🫠
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'b3b5b6be9e07710872a19f227423699f3e2645a6') #use my api so i can make some money 🤣..just kidding guys..mai already aamir hoon🥱 
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/hqmovierequest')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+jARGKkERm1RlNDU1')
